              ...
              <>
                ...
                >
                  ...
                  {isCartOpen && (
                    ...
                    >
                      {cart.length === 0 ? (
                        <p className="text-gray-400 font-inter text-center py-4">
                        ...
                        <>
                          ...
                          <div className="border-t border-neon-green/30 pt-3">
                            <div className="flex justify-between items-center mb-3">
                              ...
                              <span className="text-neon-green font-orbitron font-bold">
                            ...
                            <div className="flex gap-2">
                              <Link
                                to="/carrito"
                                className="flex-1 bg-dark-bg border border-neon-green text-neon-green px-3 py-2 rounded font-inter text-sm text-center hover:bg-neon-green/10 transition-colors"
                              >
                                Ver Carrito
                              </Link>
                              <Link
                                to="/carrito"
                                className="flex-1 bg-neon-green text-dark-bg px-3 py-2 rounded font-inter text-sm text-center hover:bg-neon-green/80 transition-colors font-bold"
                              >
                                Checkout
                              </Link>
                            </div>
